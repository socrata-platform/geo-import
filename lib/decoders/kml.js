...
var util = {
  ...
  setOrCloneFeature: function setOrCloneFeature(state, kind, coordinateMerger) {
    var aFeature = _underscore2['default'].find(state.features, function (feature) {
...
var KML = (function (_Transform) {
  ...
  _createClass(KML, [{
    ...
    value: function _getHandler(state, handlers) {
      ...
      return _underscore2['default'].find(paths, function (path) {
    ...
    value: function _propToSoQL(schema, name, value) {
      var column = _underscore2['default'].find(schema, function (column) {
