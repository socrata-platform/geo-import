...
import {geomTypes, types} from '../soql/mapper';
import {PassThrough} from 'stream';

function geomToSoQL(geom) {
  var t = geomTypes[geom.type.toLowerCase()];
  if (!t) {
    console.error("Invalid geometry type", geom.type);
    return false;
  }
  return new t("the_geom", geom.coordinates);
}
