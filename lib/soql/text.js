...
var SoQLText = (function (_SoQL) {
  _inherits(SoQLText, _SoQL);

  function SoQLText(name, value) {
    _classCallCheck(this, SoQLText);

    _get(Object.getPrototypeOf(SoQLText.prototype), 'constructor', this).call(this, name, value);
    /**
